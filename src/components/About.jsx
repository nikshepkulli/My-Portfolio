...
const About = () => {
  ...
  const paragraph = [
    `🚀 Innovative Entrepreneur & Full-Stack Technologist with ${yearsExp}+ years of experience building solutions from concept to scale across hardware, software, and data science domains. Currently Co-Founder & CTO of Starteryou Inc.—architecting and leading a platform connecting 100,000+ teenagers with meaningful employment opportunities across America—and Head of Engineering at Organic Mandya, where I lead the omnichannel engineering (customer mobile app, Shopify storefront, and real-time inventory/availability systems) for a 21-store organic retail business.`,
